...
| **双模 Supervisor** | **L2 基本可用** — L1/L2 已接入；Web 手工 15 场景见 **§10.3**；规格 [`docs/requirement/双模方案2-finish.md`](./requirement/双模方案2-finish.md) · 总览 [`docs/双模机制详解.md`](./双模机制详解.md) |
...
- [`docs/双模机制详解.md`](./双模机制详解.md) — L0 / L1 / L2 双模总览
- [`docs/L2监管层详解.md`](./L2监管层详解.md) — L2 接管 / 交还深读
